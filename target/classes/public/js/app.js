(function() {
	var app = angular.module('app', [ 'ui.router', 'navController',
			...
			'app.services', 'app.chocolateServices' ])
	...
	app.config(
			function($stateProvider, $urlRouterProvider, $controllerProvider) {
				...
				.state('home', {
					...
					url : '/chocolates',
					templateUrl : viewsPrefix + 'chocolates.html',
					controller : 'ChocolatesListController'
				}).state('viewChocolate', {
					url : '/viewChocolate/:recordid/view',
					templateUrl : viewsPrefix + 'chocolate-view.html',
					controller : 'ChocolateViewController'
				}).state('newChocolate', {
					url : '/addChocolate',
					templateUrl : viewsPrefix + 'chocolate-add.html',
